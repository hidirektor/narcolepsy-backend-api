const endpoints = [
    ...
    },
    {
        ...
        path: 'restricted/add-user',
        method: 'post',
        summary: 'Add a new user',
        description: 'Allows SYSOP to add a new user with the specified details.',
        body: {
            userName: { type: 'string', required: true, description: 'First name of the user' },
            userSurname: { type: 'string', required: true, description: 'Last name of the user' },
            eMail: { type: 'string', required: true, description: 'Email of the user' },
            nickName: { type: 'string', required: true, description: 'Nickname of the user' },
            phoneNumber: { type: 'string', required: true, description: 'Phone number of the user' },
            countryCode: { type: 'string', required: true, description: 'Country code of the user' },
            password: { type: 'string', required: true, description: 'Password for the user' },
            birthDate: { type: 'string', required: true, description: 'Birthdate of the user' },
            userType: {
                type: 'string',
                required: true,
                enum: ['USER', 'PREMIUM', 'MODERATOR', 'EDITOR', 'SUPPORT', 'SYSOP'],
        ...
        security: [{ bearerAuth: [] }],
        controller: 'controllers/providers/restrictedController.addUserAsync',
    },
    {
        sectionTitle: 'Restricted Management',
        path: 'restricted/edit-user',
        method: 'put',
        summary: 'Edit an existing user',
        description: 'Allows SYSOP to edit the details of an existing user.',
        body: {
            userID: { type: 'string', required: true, description: 'Unique ID of the user to be edited' },
            userName: { type: 'string', required: false, description: 'First name of the user' },
            userSurname: { type: 'string', required: false, description: 'Last name of the user' },
            eMail: { type: 'string', required: false, description: 'Email of the user' },
            nickName: { type: 'string', required: false, description: 'Nickname of the user' },
            phoneNumber: { type: 'string', required: false, description: 'Phone number of the user' },
            countryCode: { type: 'string', required: false, description: 'Country code of the user' },
            password: { type: 'string', required: false, description: 'Password for the user' },
            birthDate: { type: 'string', required: false, description: 'Birthdate of the user' },
            userType: {
                type: 'string',
                required: false,
                enum: ['USER', 'PREMIUM', 'MODERATOR', 'EDITOR', 'SUPPORT', 'SYSOP'],
        ...
        security: [{ bearerAuth: [] }],
        controller: 'controllers/providers/restrictedController.editUserAsync',
    },
    {
        sectionTitle: 'Restricted Management',
        path: 'restricted/delete-user/:userID',
        method: 'delete',
        summary: 'Delete a user',
        description: 'Allows SYSOP to delete an existing user by their userID.',
        parameters: {
            userID: { type: 'string', required: true, description: 'Unique ID of the user to be deleted' },
        },
        responses: {
        ...
        security: [{ bearerAuth: [] }],
        controller: 'controllers/providers/restrictedController.deleteUserAsync',
    },
    {
        sectionTitle: 'Restricted Management',
        path: 'restricted/delete-comment/:id',
        method: 'delete',
        summary: 'Delete a comment',
        description: 'Allows SYSOP to delete a user comment by its commentID.',
        parameters: {
            id: { type: 'string', required: true, description: 'Unique ID of the comment to be deleted' },
        },
        responses: {
            200: { description: 'Comment deleted successfully' },
            400: { description: 'Validation error' },
        ...
        security: [{ bearerAuth: [] }],
        controller: 'controllers/providers/restrictedController.deleteCommentAsync',
    },
    {
        sectionTitle: 'Restricted Management',
        path: 'restricted/delete-rating/:id',
        method: 'delete',
        summary: 'Delete a rating',
        description: 'Allows SYSOP to delete a user rating by its ratingID.',
        parameters: {
            id: { type: 'string', required: true, description: 'Unique ID of the rating to be deleted' },
        },
        responses: {
            200: { description: 'Rating deleted successfully' },
            400: { description: 'Validation error' },
        ...
        security: [{ bearerAuth: [] }],
        controller: 'controllers/providers/restrictedController.deleteRatingAsync',
    },
    {
        sectionTitle: 'Restricted Management',
        path: 'restricted/delete-download/user/:userID/episode/:episodeID',
        method: 'delete',
        summary: 'Delete a download',
        description:
            'Allows SYSOP to delete a user download entry by specifying both userID and episodeID in the request.',
        parameters: {
            userID: { type: 'string', required: true, description: 'Unique ID of the user' },
            episodeID: { type: 'string', required: true, description: 'Unique ID of the episode' },
        },
        responses: {
            200: { description: 'Download entry deleted successfully' },
            400: { description: 'Validation error' },
            404: { description: 'Download entry not found' },
            500: { description: 'Internal server error' },
        },
        security: [{ bearerAuth: [] }],
